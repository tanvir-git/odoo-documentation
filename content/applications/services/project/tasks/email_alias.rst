...
.. image:: email_alias/email_project.png
   :align: center
   :alt: In the settings of your project, define the emails alias under the tab email in CoquiAPPs Project
...
.. image:: email_alias/email_dashboard_project.png
   :align: center
   :height: 300
   :alt: View of the email alias chosen on the dashboard view in CoquiAPPs Project
