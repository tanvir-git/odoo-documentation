...
.. image:: onsite_interventions/product-configuration.png
   :align: center
   :alt: Product configuration to create tasks from sales orders in CoquiAPPs Field Service
...
.. image:: onsite_interventions/task-on-so.png
   :align: center
   :alt: Field Service task on a sales order in CoquiAPPs Sales
...
.. image:: onsite_interventions/helpdesk-settings.png
   :align: center
   :alt: Onsite interventions settings in CoquiAPPs Helpdesk
...
.. image:: onsite_interventions/plan-intervention-from-ticket.png
   :align: center
   :alt: Plan intervention from helpdesk tickets in CoquiAPPs Helpdesk
