...
.. note::
   ...
   by clicking the :guilabel:`X` next to :guilabel:`My Mailings` in the search bar. Doing so,
   reveals all the information for every email in the database.

Default Kanban view and Kanban stages
-------------------------------------

The four kanban columns each represent the various stages (statuses) of emails that have been built
(and sent) within the *Email Marketing* application.
...
dots (:guilabel:`⋮`) appear. When clicked, a mini drop-down reveals the option to color-code the
...
.. tabs::
   ...
   .. tab:: Filters
      ...
      This drop-down provides different ways to filter email information on the dashboard. The
      ...
      additional drop-down, with three customizable fields to fill in, and Odoo reveals the
   ...
   .. tab:: Favorites
      ...
      This drop-down provides different ways to incorporate past search filters and other
