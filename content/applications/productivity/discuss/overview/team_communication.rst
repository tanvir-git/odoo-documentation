...
.. image:: team_communication/channel_settings.png
   :align: center
   :alt: View of a channel’s settings form in CoquiAPPs Discuss
...
.. image:: team_communication/invite_channel.png
   :align: center
   :height: 380
   :alt: View of Discuss’ sidebar emphasizing the option to invite members in CoquiAPPs Discuss
...
.. image:: team_communication/pending_moderation.png
   :align: center
   :alt: View of a message with a pending moderation status in CoquiAPPs Discuss
...
.. image:: team_communication/moderation_settings.png
   :align: center
   :alt: View of a channel’s settings form emphasizing the tab moderation in CoquiAPPs Discuss

Moderators can: *Accept*, *Reject*, *Discard*, *Always Allow* or *Ban* messages.

.. image:: team_communication/moderate_messages.png
   :align: center
   :alt: View of a message to be moderated in CoquiAPPs Discuss
...
.. image:: team_communication/ban_list.png
   :align: center
   :alt: View of a channel’s setting form emphasizing the ban Lists menu in CoquiAPPs Discuss
...
.. image:: team_communication/quick_search.png
   :align: center
   :height: 430
   :alt: View of the Discuss’ sidebar emphasizing the quick search bar in CoquiAPPs Discuss
...
.. image:: team_communication/filter.png
   :align: center
   :alt: View of a channel being searched through filters in CoquiAPPs Discuss
