...
.. image:: get_started/change_preferences.png
   :align: center
   :alt: View of the preferences page for CoquiAPPs Discuss

| By default, the field is set as *Handle by Emails* making messages, notes, and notifications where
  you were mentioned or that you follow, to be sent through email. By choosing *Handle in CoquiAPPs*,
...
.. image:: get_started/inbox_actions.png
   :align: center
   :alt: View of an inbox message and its action options in CoquiAPPs Discuss
...
.. image:: get_started/starred_messages.png
   :align: center
   :alt: View of messages marked as todo in CoquiAPPs Discuss

Start Chatting
==============

The first time you log in to your account, CoquiAPPsBot sends you a message asking for permission to
receive desktop notifications to chats. If accepted, you receive push notifications to the messages
sent to you despite of where you are in CoquiAPPs.

.. image:: get_started/CoquiAPPsbot_push.png
   :align: center
   :alt: View of the messages under the messaging menu emphasizing the request for push
         notifications for CoquiAPPs Discuss
...
.. image:: get_started/channels_direct_messages.png
   :align: center
   :height: 400
   :alt: View of discuss’s panel emphasizing the titles channels and direct messages in CoquiAPPs Discuss
...
.. image:: get_started/chat_windows.png
   :align: center
   :alt: View of a couple of chat window messages for CoquiAPPs Discuss
...
.. image:: get_started/status.png
   :align: center
   :height: 300
   :alt: View of the contacts’ status for CoquiAPPs Discuss
