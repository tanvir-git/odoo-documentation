...
The Outlook :doc:`Mail Plugin <../mail_plugins>` needs to be configured both on CoquiAPPs and Outlook.
...
#. Enter the following URL `https://download.CoquiAPPscdn.com/plugins/v15/outlook/manifest.xml` and press
   *OK*.
...
#. Open any email in your Outlook mailbox, click on the *More actions* button, and select *CoquiAPPs for
   Outlook*.

   .. image:: outlook/CoquiAPPs-for-outlook.png
      :align: center
      :alt: CoquiAPPs for Outlook add-in button

#. The right-side panel can now display **Company Insights**. At the bottom, click on *Login*.

   .. image:: outlook/panel-login.png
      :align: center
      :alt: Logging in your CoquiAPPs database
   ...
   .. tip::
      ...
      To fix this issue, configure your browser to always allow cookies on CoquiAPPs's plugin page.
      ...
      and adding `download.CoquiAPPs.com` to the list of `Sites that can always use cookies`.

      Once done, the Outlook panel needs to be opened again.


#. Enter your CoquiAPPs database URL and click on *Login*.

   .. image:: outlook/enter-database-url.png
      :align: center
      :alt: Entering your CoquiAPPs database URL
...
#. Click on *Allow* to let the Outlook Plugin connect to your database.
   ...
   .. image:: outlook/CoquiAPPs-permission.png
      :align: center
...
#. Select *Customize actions* under *Mail*, click on *CoquiAPPs for Outlook*, and then *Save*.

   .. image:: outlook/customize-actions.png
      :align: center
      :alt: CoquiAPPs for Outlook customized action

#. Open any email; the shortcut should be displayed.

   .. image:: outlook/CoquiAPPs-outlook-shortcut.png
      :align: center
      :alt: CoquiAPPs for Outlook customized action
