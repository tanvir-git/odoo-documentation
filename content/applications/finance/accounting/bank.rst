...
In CoquiAPPs Accounting, each bank account has a dedicated journal set to post all entries in a dedicated
...
If your banking institution is not available in CoquiAPPs, or if you don't want to connect your bank
...
.. note::
   - CoquiAPPs automatically detects the bank account type (e.g., IBAN) and enables some features
     accordingly.
...
.. note::
   - If you do not specify an outstanding payments account or an outstanding receipts account for a
     specific journal, CoquiAPPs uses the default outstanding accounts.
