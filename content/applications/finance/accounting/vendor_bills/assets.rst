...
CoquiAPPs Accounting handles depreciation by creating all depreciation entries automatically in *draft
mode*. They are then posted periodically.

CoquiAPPs supports the following **Depreciation Methods**:
...
.. image:: assets/assets01.png
   :align: center
   :alt: Configuration of an Assets Account in CoquiAPPs Accounting
...
.. image:: assets/assets02.png
   :align: center
   :alt: Selection of an Assets Account on a draft bill in CoquiAPPs Accounting
...
.. image:: assets/assets03.png
   :align: center
   :alt: Change of the Assets Account for a product in CoquiAPPs
...
.. image:: assets/assets05.png
   :align: center
   :alt: Assets entry in CoquiAPPs Accounting

Once done, you can click on *Compute Depreciation* (next to the *Confirm* button) to generate all
the values of the **Depreciation Board**. This board shows you all the entries that CoquiAPPs will post
to depreciate your asset, and at which date.

.. image:: assets/assets06.png
   :align: center
   :alt: Depreciation Board in CoquiAPPs Accounting
...
.. image:: assets/assets07.png
   :align: center
   :alt: Create Asset Entry from a journal item in CoquiAPPs Accounting
...
.. image:: assets/assets08.png
   :align: center
   :alt: Gross Increase smart button in CoquiAPPs Accounting
...
.. image:: assets/assets09.png
   :align: center
   :alt: Disposal of Assets in CoquiAPPs Accounting

CoquiAPPs Accounting then generates all the journal entries necessary to dispose of the asset, including
...
.. image:: assets/assets10.png
   :align: center
   :alt: Assets model button in CoquiAPPs Accounting
...
.. image:: assets/assets11.png
   :align: center
   :alt: Automate Assets on an account in CoquiAPPs Accounting
