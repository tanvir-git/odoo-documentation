...
CoquiAPPs Accounting handles deferred expenses and prepayments by spreading them in multiple entries that
...
.. image:: deferred_expenses/deferred_expenses01.png
   :align: center
   :alt: Configuration of a Deferred Expense Account in CoquiAPPs Accounting
...
.. image:: deferred_expenses/deferred_expenses02.png
   :align: center
   :alt: Selection of a Deferred Expense Account on a draft bill in CoquiAPPs Accounting
...
.. image:: deferred_expenses/deferred_expenses03.png
   :align: center
   :alt: Change of the Expense Account for a product in CoquiAPPs
...
.. image:: deferred_expenses/deferred_expenses05.png
   :align: center
   :alt: Deferred Expense entry in CoquiAPPs Accounting

Once done, you can click on *Compute Deferral* (next to the *Confirm* button) to generate all the
values of the **Expense Board**. This board shows you all the entries that CoquiAPPs will post to
recognize your expense, and at which date.

.. image:: deferred_expenses/deferred_expenses06.png
   :align: center
   :alt: Expense Board in CoquiAPPs Accounting
...
.. image:: deferred_expenses/deferred_expenses08.png
   :align: center
   :alt: Deferred Expense model button in CoquiAPPs Accounting
...
.. image:: deferred_expenses/deferred_expenses09.png
   :align: center
   :alt: Automate Deferred Expense on an account in CoquiAPPs Accounting
