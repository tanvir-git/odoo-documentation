...
In CoquiAPPs, payments can either be linked automatically to an invoice or bill or be stand-alone records
...
.. seealso::
   ...
   - `CoquiAPPs Tutorials: Bank Configuration
     <https://coqui.cloud/slides/slide/bank-configuration-1880>`_
...
.. note::
   ...
   - If your main bank account is set as :ref:`outstanding account
     <bank/outstanding-accounts>`, and the payment is made in CoquiAPPs (not related to a
