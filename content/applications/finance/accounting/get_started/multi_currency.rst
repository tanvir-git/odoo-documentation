...
CoquiAPPs allows you to issue invoices, receive bills, and record transactions in currencies other than
...
CoquiAPPs can update the rates at regular intervals. To do so, change the :guilabel:`Interval` from
...
CoquiAPPs automatically records exchange differences entries on dedicated accounts, in a dedicated
journal.
...
.. example::
   ...
   exchange difference, which CoquiAPPs automatically records in the default **Exchange Difference**
   journal.
...
When reconciling, CoquiAPPs displays both the foreign currency amount and the equivalent amount in your
