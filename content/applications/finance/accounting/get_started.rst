...
When you first open your CoquiAPPs Accounting app, the *Accounting Overview* page welcomes you with a
...
.. note::
   CoquiAPPs Accounting automatically installs the appropriate **Fiscal Localization Package** for your
...
.. image:: get_started/setup_accounting_onboarding.png
   :alt: Step-by-step onboarding banner in CoquiAPPs Accounting
...
.. image:: get_started/setup_company.png
   :alt: Add your company's details in CoquiAPPs Accounting and CoquiAPPs Invoicing
...
- **Name**: the bank account's name, as displayed on CoquiAPPs.
...
- **Code**: this code is your Journal's *Short Code*, as displayed on CoquiAPPs. By default, CoquiAPPs creates
...
.. image:: get_started/setup_chart_of_accounts.png
   :alt: Setup of the Chart of Accounts and their opening balances in CoquiAPPs Accounting
...
There is another step-by-step onboarding banner that helps you take advantage of your CoquiAPPs Invoicing
...
If you have CoquiAPPs Accounting installed on your database, you can reach it by going to
:menuselection:`Accounting --> Customers --> Invoices`.

The Invoicing onboarding banner is composed of four main steps:

.. image:: get_started/setup_invoicing_onboarding.png
   :alt: Step-by-step onboarding banner in CoquiAPPs Invoicing
...
You can also add your *Company Tagline* and the content of the documents’ *footer*. Note that CoquiAPPs
...
.. image:: get_started/setup_document_layout.png
   :alt: Document layout configuration in CoquiAPPs Invoicing
...
.. seealso::
   ...
   * `CoquiAPPs Tutorials: Accounting Basics <https://coqui.cloud/r/lsZ>`_
