...
CoquiAPPs can synchronize directly with your bank institution to get all bank statements imported
automatically into your database.

To check if your bank is compatible with CoquiAPPs, go to `CoquiAPPs Accounting Features
<https://coqui.cloud/page/accounting-features>`_, and click on
:guilabel:`See list of supported institutions`.

CoquiAPPs supports more than 25,000 institutions around the world.

To connect to the banks, CoquiAPPs uses multiple web-services:
...
To be able to use this service, you need to have a valid CoquiAPPs Enterprise subscription.
So make sure that your database is registered with your CoquiAPPs Enterprise contract.
...
- https://production.CoquiAPPsfin.com/
...
.. important::
   ...
   start recording accounting transaction on your CoquiAPPs accounting database. For example, if you
   import your closing balance in CoquiAPPs on the 31/12/2022 and you start recording accounting
...
bank institution.
This information is not stored on CoquiAPPs's servers.
...
To report a connection error to the `CoquiAPPs support <https://coqui.cloud/help>`_, go to
...
.. note::
   This disconnection can be caused by the CoquiAPPs support. In this case, please contact the `support
   <https://coqui.cloud/help>`_ directly with your client id or the reference of the error listed
   in the chatter.

.. _MigrationOnlineSync:

Migration process for users having installed CoquiAPPs before December 2020
======================================================================
...
Finally, make sure all your users refresh their CoquiAPPs page by pressing CTRL+F5.
...
or other problems may arise. CoquiAPPs does not support technical problems that occur with banks in the
...
Not all of my past transactions are in CoquiAPPs, why?
-------------------------------------------------
...
CoquiAPPs. If you didn't synchronize any of your accounts, you can go to
...
database, please `submit a support ticket <https://coqui.cloud/help>`_.
