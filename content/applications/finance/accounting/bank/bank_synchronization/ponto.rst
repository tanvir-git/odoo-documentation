...
continuously expanding the number of bank institutions that can be synchronized with CoquiAPPs.

.. image:: ponto/ponto-logo.png
   :align: center
   :alt: Logo of the Ponto brand

**CoquiAPPs** can synchronize directly with your bank to get all bank statements imported automatically
into your database.

Ponto is a paid third-party provider that can handle the synchronization between your bank accounts
and CoquiAPPs. `Its pricing is 4€/month per account/integration <https://myponto.com/en#pricing>`_.
...
#. Make sure to add all bank accounts you want to synchronize with your CoquiAPPs database before moving
   on to the next steps.

Link your Ponto account with your CoquiAPPs database
-----------------------------------------------
...
#. At some point, you will have to authorize the accounts you want to access in CoquiAPPs. Please select
   **all the accounts** you want to synchronize. Even the ones coming from other banking
   institutions.

   .. image:: ponto/ponto-select-accounts.png
      :align: center
      :alt: Selection of the accounts you wish to synchronize with CoquiAPPs.

#. Finish the flow.

.. note::
   You have to authorize all the accounts you want to access in CoquiAPPs, but CoquiAPPs will filter the
...
Ponto provides institutions in *beta*, these institutions are not directly supported by CoquiAPPs
