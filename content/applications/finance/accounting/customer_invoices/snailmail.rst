...
their email inboxes are overflowing. With CoquiAPPs, you have the ability to send invoices and follow-up
...
.. image:: snailmail/setup-snailmail.png
   :align: center
   :alt: Under settings enable the snailmail feature in CoquiAPPs Accounting
...
.. important::
   ...
   - Margins must be **5 mm** on all sides. As CoquiAPPs forces the outer margins by filling them with
   ...
   - Pingen (CoquiAPPs Snailmail service provider) scans the area to process the address, so if something
...
Purchases: CoquiAPPs IAP`, and click on :guilabel:`View my Services`.

.. tip::
   - If you are on CoquiAPPs Online and have the Enterprise version, you benefit from free trial credits
     to test the feature.
   - Click `here <https://iap.CoquiAPPs.com/privacy#header_4>`_ to know about our *Privacy Policy*.
