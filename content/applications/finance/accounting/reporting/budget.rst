...
performance against the plan. CoquiAPPs manages budgets using both **general** and **analytic accounts**.
...
CoquiAPPs needs to know which costs or expenses are relevant to a specified budget, as the above general
