...
your company's localization. To make sure they are recorded with accuracy, CoquiAPPs's tax engine
...
other indication about which tax to use. For example, CoquiAPPs prefills the **Taxes** field with the
Default Taxes when you create a new product or add a new line on an invoice.

.. image:: taxes/default-invoice-line.png
   :alt: CoquiAPPs fills out the Tax field automatically according to the Default Taxes
...
.. image:: taxes/default-configuration.png
   :alt: Define which taxes to use by default on CoquiAPPs
...
.. image:: taxes/list.png
   :alt: Activate pre-configured taxes in CoquiAPPs Accounting
...
.. image:: taxes/edit.png
   :alt: Edition of a tax in CoquiAPPs Accounting
...
.. warning::
   ...
   .. image:: taxes/list-sequence.png
      :alt: The taxes' sequence in CoquiAPPs determines which tax is applied first
