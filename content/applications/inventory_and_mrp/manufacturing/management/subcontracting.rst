...
With its MRP subcontracting feature, CoquiAPPs helps you handle this flow easily.
...
quantity received. As a result, CoquiAPPs does the following things for you:
...
.. note::
      ...
      subcontractor, CoquiAPPs still performs all the moves. This can be useful if
