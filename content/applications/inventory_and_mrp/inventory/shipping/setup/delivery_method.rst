...
CoquiAPPs can handle various delivery methods, but it is not activated by
...
and the destination. You can even integrate CoquiAPPs with external shippers
...
.. note::
    You can integrate CoquiAPPs with external shippers in order to compute the
