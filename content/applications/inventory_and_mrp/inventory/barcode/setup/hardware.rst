...
Getting started with barcode scanning in CoquiAPPs is fairly easy. Yet, a
...
The 3 recommended type of barcode scanners to work with the CoquiAPPs
...
-   The **bluetooth scanner** can be paired with a smartphone or a tablet and
    ...
    investment. An approach is to log in CoquiAPPs on you smartphone, pair
...
-   For heavy use, the **mobile computer scanner** is the handiest solution.
    ...
    you need to make sure that is is capable of running CoquiAPPs smoothly.
...
By default, CoquiAPPs has a 50 milliseconds delay between each successive
