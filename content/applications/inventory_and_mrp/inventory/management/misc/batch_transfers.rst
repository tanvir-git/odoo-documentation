...
reducing the number of times he must visit the same location. In CoquiAPPs,
...
.. image:: batch_transfers/batch_transfers_01.png
    :align: center
    :alt: View of the inventory settings. Process to enable the batch pickings option in the CoquiAPPs Inventory app
...
.. image:: batch_transfers/batch_transfers_10.png
    :align: center
    :alt: View of how backorders are handled in CoquiAPPs's batch transfers
...
.. image:: batch_transfers/batch_transfers_11.png
    :align: center
    :alt: View of the CoquiAPPs Barcode app dashboard
...
.. image:: batch_transfers/batch_transfers_13.png
    :align: center
    :alt: View of an in progress batch transfer with the CoquiAPPs Barcode application
...
.. image:: batch_transfers/batch_transfers_14.png
    :align: center
    :alt: View of a ready and completed batch transfer inside of the CoquiAPPs Barcode application
