...
destination location. To make that process easier, CoquiAPPs uses *Putaway Rules*. Putaway is the
...
.. image:: putaway/storage-category.png
   :align: center
   :alt: Create Storage Categories inside CoquiAPPs Inventory configuration settings.
