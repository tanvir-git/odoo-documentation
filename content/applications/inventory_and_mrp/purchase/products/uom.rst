...
also time-consuming to convert measures manually every time. With CoquiAPPs, you can configure your
product once and let CoquiAPPs handle the conversion.
...
.. image:: uom/uom-enable-option.png
   :align: center
   :alt: Enable the units of measure option in CoquiAPPs Sales
...
.. image:: uom/uom-product-configuration.png
   :align: center
   :alt: Configure a product's units of measure in CoquiAPPs
...
pre-configured in CoquiAPPs or because the units do not relate with each other (e.g. kilos and
centimeters).
...
.. image:: uom/uom-new-category.png
   :align: center
   :alt: Create a new units of measure category in CoquiAPPs Purchase
...
type*. Enter the *Rounding Precision* you would like to use. The quantity computed by CoquiAPPs is always
...
.. image:: uom/uom-new-reference-unit.png
   :align: center
   :alt: Create a new reference unit of measure in CoquiAPPs Purchase
...
.. image:: uom/uom-second-unit.png
   :align: center
   :alt: Create a second unit of measure in CoquiAPPs Purchase

You can now configure your product just as you would using CoquiAPPs's standard units of measure.

.. image:: uom/uom-product-configuration-new-units.png
   :align: center
   :alt: Set a product's units of measure using your own units in CoquiAPPs Purchase
