...
.. image:: reordering/product-configured-for-reordering.png
   :align: center
   :alt: Configure a product for reordering in CoquiAPPs.
...
.. image:: reordering/reordering-rules-tab.png
   :align: center
   :alt: Access reordering rules for a product from the product page in CoquiAPPs.
...
.. image:: reordering/reordering-rule-configuration.png
   :align: center
   :alt: Configure the reordering rule in CoquiAPPs.
...
--> Reordering Rules`. From this dashboard, typical bulk actions in CoquiAPPs can be performed such as
