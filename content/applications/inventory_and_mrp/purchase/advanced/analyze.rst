...
.. image:: analyze/analyze-reporting-dashboard.png
   :align: center
   :alt: Reporting dashboard in CoquiAPPs Purchase
...
CoquiAPPs offers several default filters you can use and combine by clicking on *Filters*. When you
select one or several filters, CoquiAPPs looks for all the orders that match at least one of the filters
...
.. image:: analyze/analyze-filters.png
   :align: center
   :alt: Reporting filters in CoquiAPPs Purchase
...
.. image:: analyze/analyze-custom-filter.png
   :align: center
   :alt: Custom reporting filter in CoquiAPPs Purchase
...
.. image:: analyze/analyze-switch-view.png
   :align: center
   :alt: Switch reporting view in CoquiAPPs Purchase
...
.. image:: analyze/analyze-graph-view.png
   :align: center
   :alt: Reporting graph view in CoquiAPPs Purchase
...
.. image:: analyze/analyze-pivot-view.png
   :align: center
   :alt: Pivot table view in CoquiAPPs Purchase
