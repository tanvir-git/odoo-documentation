...
**CoquiAPPs Rental** is a comprehensive solution to manage your rentals.
...
.. seealso::
   - `CoquiAPPs Rental: product page <https://coqui.cloud/app/rental>`_
   - `CoquiAPPs Tutorials: Rental <https://coqui.cloud/slides/rental-48>`_
...
.. image:: rental/rental-pricing-example.png
   :align: center
   :alt: Example of rental pricing configuration in CoquiAPPs Rental
...
CoquiAPPs always uses two rules to compute the price of a product when you create a rental order:
...
.. exercise::
   ...
   After an order is created, CoquiAPPs selects the second line as this is the cheapest option. The
...
.. image:: rental/digital-documents-settings.png
   :align: center
   :alt: Digital Documents settings in CoquiAPPs Rental

.. note::
   This feature requires the :doc:`Sign <../finance/sign>` app. If necessary, CoquiAPPs installs it after
...
open any rental order, click on *Print* and select *Pickup and Return Receipt*. CoquiAPPs then generates
...
.. image:: rental/print-receipt.png
   :align: center
   :alt: Printing a Pickup and Return receipt in CoquiAPPs Rental
