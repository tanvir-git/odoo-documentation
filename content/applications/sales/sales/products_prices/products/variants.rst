...
The :guilabel:`Variants Creation Mode` informs CoquiAPPs when to automatically create a new variant once
...
apply the setting, and CoquiAPPs will automatically show the product variant as unavailable on the
eCommerce page.
