...
.. image:: multi_sales_team/sales-team-creation.png
   :align: center
   :alt: Create a sales team in CoquiAPPs CRM.
...
.. image:: multi_sales_team/add-a-salesperson.png
   :align: center
   :alt: Add a salesperson in CoquiAPPs CRM.
...
To view the sales team dashboard, go to :menuselection:`CRM --> Sales --> Teams`. CoquiAPPs users will
...
.. image:: multi_sales_team/sales-team-overview.png
   :align: center
   :alt: Sales team overview dashboard in CoquiAPPs CRM.
...
.. image:: multi_sales_team/team-overview-three-dot-menu.png
   :align: center
   :alt: Click the Three Dot Menu in CoquiAPPs CRM dashboard to view documents and create opportunities.
