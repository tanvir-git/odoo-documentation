...
If you already have an opportunity with that customer CoquiAPPs will
automatically offer you to merge with that opportunity. In the same
manner, CoquiAPPs will automatically offer you to link to an existing
customer if that customer already exists.

Merge opportunities
===================

CoquiAPPs will also automatically propose to merge opportunities if they have
the same email address. When merging opportunities, CoquiAPPs merges the
