...
In summary, the **CoquiAPPs Subscriptions** application gives you the
...
.. image:: closing/configuration-to-close-your-subscriptions.png
  :align: center
  :alt: Configuration to close your subscription with CoquiAPPs Subscriptions
...
.. note::
   ...
   **CoquiAPPs Subscriptions** application.
...
.. image:: closing/close-your-subscriptions-as-an-administrator.png
  :align: center
  :alt: Close your subscription from an administration point of view with CoquiAPPs Subscriptions
...
.. image:: closing/use-of-close-reasons.png
  :align: center
  :alt: What happens when you close your subscription with CoquiAPPs Subscriptions?
...
.. image:: closing/close-your-subscriptions-as-a-customer.png
  :align: center
  :alt: Close your subscription from a customer point of view with CoquiAPPs Subscriptions
...
.. image:: closing/use-of-close-reasons-as-a-customer.png
  :align: center
  :alt: What happens when customers close their subscription with CoquiAPPs Subscriptions?
...
.. image:: closing/chatter-history-when-a-customer-closes-a-subscription.png
  :align: center
  :alt: What happens when customers close their subscription in CoquiAPPs Subscriptions?
...
.. note::
   ...
   to understand how subscriptions are managed in the **CoquiAPPs Subscriptions** application.
