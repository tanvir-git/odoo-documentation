...
.. image:: subscription_reports/difference-between-MRR-and-ARR.png
  :align: center
  :alt: Difference between MRR and ARR in CoquiAPPs Subscriptions
  ...
  - **Revenue Churn**: It corresponds to the monthly recurring revenue loss rate.
    ...
    .. example::
       ...
       .. image:: subscription_reports/difference-between-logo-churn-and-revenue-churn.png
          :align: center
          :alt: Difference between logo churn and revenue churn in CoquiAPPs Subscriptions
...
Check out the different kinds of reports you can access from the **CoquiAPPs Subscriptions**
application.
...
the *Measures*. By default, CoquiAPPs uses the *Monthly Recurring Revenue*. In addition to that, you
...
.. image:: subscription_reports/subscriptions-analysis-report.png
  :align: center
  :alt: Subscriptions analysis report in CoquiAPPs Subscriptions
...
.. image:: subscription_reports/retention-analysis-report.png
  :align: center
  :alt: Retention analysis report in CoquiAPPs Subscriptions
...
.. image:: subscription_reports/revenue-KPIs-report.png
  :align: center
  :alt: Revenue KPIs report in CoquiAPPs Subscriptions
...
.. image:: subscription_reports/detailed-MRR-report.png
  :align: center
  :alt: Detailed MRR report in CoquiAPPs Subscriptions
...
.. image:: subscription_reports/salesperson-dashboard-report.png
  :align: center
  :alt: Salesperson dashboard report in CoquiAPPs Subscriptions
