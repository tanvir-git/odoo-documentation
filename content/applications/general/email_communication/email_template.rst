...
communication between your customer and your CoquiAPPs database. For more information about the way
...
When using CoquiAPPs, multiple events trigger the sending of automated emails. These emails are known
as transactional emails and sometimes contain links pointing to your CoquiAPPs database.
...
This is not always the case as some CoquiAPPs applications have a link established in the database with
...
On the other hand, sales orders made by a customer on one of your CoquiAPPs e-commerce websites have a
